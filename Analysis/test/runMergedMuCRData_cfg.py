...
process = cms.Process('MergedMuCRanalyzer')
...
from ZprimeTo4l.Analysis.MergedMuCRanalyzer_cfi import mergedMuCRanalyzer
process.mergedMuCRanalyzerData = mergedMuCRanalyzer.clone(
