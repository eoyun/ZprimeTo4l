...
void drawStackFakeMu(TString era) {
  TH1::SetDefaultSumw2();
  ...
  TFile* datafile1 = new TFile("FakeMuAnalyzer_20UL16APV_data.root","READ");
  TFile* datafile2 = new TFile("FakeMuAnalyzer_20UL16_data.root","READ");
  TFile* datafile3 = new TFile("FakeMuAnalyzer_20UL17_data.root","READ");
  TFile* datafile4 = new TFile("FakeMuAnalyzer_20UL18_data.root","READ");
  ...
  std::vector<TString> treeNames = {"denomTree1e","numerTree1e","denomTree2e","numerTree2e"};
  std::vector<histo> varNames = {histo("m1m2InvM",0.,20.),histo("m1m2Pt",0.,200.),histo("m1m2DR",0.,0.4),};

  for (auto atree : treeNames) {
    for (auto ahist : varNames) {

      auto* datahist = retrieveDataHist(datafile1,"resolvedFakeMuCRanalyzerData",atree,ahist.name_,ahist.xmin_,ahist.xmax_);
      datahist->Add( retrieveDataHist(datafile2,"resolvedFakeMuCRanalyzerData",atree,ahist.name_,ahist.xmin_,ahist.xmax_) );
      datahist->Add( retrieveDataHist(datafile3,"resolvedFakeMuCRanalyzerData",atree,ahist.name_,ahist.xmin_,ahist.xmax_) );
      datahist->Add( retrieveDataHist(datafile4,"resolvedFakeMuCRanalyzerData",atree,ahist.name_,ahist.xmin_,ahist.xmax_) );
      sample1.retrieveHists("resolvedFakeMuCRanalyzer",atree,ahist.name_,ahist.xmin_,ahist.xmax_);
      sample2.retrieveHists("resolvedFakeMuCRanalyzer",atree,ahist.name_,ahist.xmin_,ahist.xmax_);
      sample3.retrieveHists("resolvedFakeMuCRanalyzer",atree,ahist.name_,ahist.xmin_,ahist.xmax_);
      sample4.retrieveHists("resolvedFakeMuCRanalyzer",atree,ahist.name_,ahist.xmin_,ahist.xmax_);
      ...
      if (ahist.name_.Contains("m1m2Pt"))
