...
private:
  ...
  float em_muon_2nd;
  float emS9_muon_2nd;
  float emS25_muon_2nd;
  float emMax_muon_2nd;
  float had_muon_2nd;
  float hadS9_muon_2nd;
  float hadMax_muon_2nd;
  float ho_muon_2nd;
  float hoS9_muon_2nd;
  float dxy_muon_2nd;
  float dz_muon_2nd;
...
void MuonJpsi::beginJob() {
  ...
  muon_->Branch("dxy",&dxy_muon,"dxy/F");
  muon_->Branch("dz",&dz_muon,"dz/F");
  muon_->Branch("pT_2nd",&pT_muon_2nd,"pT_2nd/F"); 
  muon_->Branch("eta_2nd",&eta_muon_2nd,"eta_2nd/F"); 
  muon_->Branch("phi_2nd",&phi_muon_2nd,"phi_2nd/F"); 
  muon_->Branch("em_2nd",&em_muon_2nd,"em_2nd/F"); 
  muon_->Branch("emS9_2nd",&emS9_muon_2nd,"ems9_2nd/F"); 
  muon_->Branch("emS25_2nd",&emS25_muon_2nd,"emS25_2nd/F"); 
  muon_->Branch("emMax_2nd",&emMax_muon_2nd,"emMax_2nd/F"); 
  muon_->Branch("had_2nd",&had_muon_2nd,"had_2nd/F"); 
  muon_->Branch("hadS9_2nd",&hadS9_muon_2nd,"hadS9_2nd/F"); 
  muon_->Branch("hadMax_2nd",&hadMax_muon_2nd,"hadMax_2nd/F"); 
  muon_->Branch("ho_2nd",&ho_muon_2nd,"ho_2nd/F"); 
  muon_->Branch("hoS9_2nd",&hoS9_muon_2nd,"hoS9_2nd/F"); 
  muon_->Branch("dxy_2nd",&dxy_muon_2nd,"dxy_2nd/F");
  muon_->Branch("dz_2nd",&dz_muon_2nd,"dz_2nd/F");
  muon_->Branch("invM",&invM_muon,"invM_2nd/F");
...
void MuonJpsi::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if (isFired){
    for (size_t i = 0; i < muonHandle->size(); ++i) {
	  ...
	  dxy_muon = muon.muonBestTrack()->dxy();
	  dz_muon = muon.muonBestTrack()->dz();
	  pT_muon_2nd = muon_sub.pt();
	  eta_muon_2nd = muon_sub.eta();
	  phi_muon_2nd = muon_sub.phi();
	  em_muon_2nd = muon_sub.calEnergy().em;
	  emS9_muon_2nd = muon_sub.calEnergy().emS9;
	  emS25_muon_2nd = muon_sub.calEnergy().emS25;
	  emMax_muon_2nd = muon_sub.calEnergy().emMax;
	  had_muon_2nd = muon_sub.calEnergy().had;
	  hadS9_muon_2nd = muon_sub.calEnergy().hadS9;
	  hadMax_muon_2nd = muon_sub.calEnergy().hadMax;
	  ho_muon_2nd = muon_sub.calEnergy().ho;
	  hoS9_muon_2nd = muon_sub.calEnergy().hoS9;
	  dxy_muon_2nd = muon_sub.muonBestTrack()->dxy();
	  dz_muon_2nd = muon_sub.muonBestTrack()->dz();
	  invM_muon = invM;
	  muon_->Fill();
