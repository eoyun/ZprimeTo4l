...
process.modifiedEcalRecHitIsolationScone2nd = cms.EDProducer("ModifiedEcalRecHitIsolationProducer",
...
process.mergedEleBkgFilter = cms.EDFilter("MergedEleBkgFilter",
    addGsfTrkMap = cms.InputTag("modifiedHEEPIDVarValueMaps2nd","eleAddGsfTrk"),
    beamSpot = cms.InputTag("offlineBeamSpot"),
    conversions = cms.InputTag("reducedEgamma","reducedConversions"),
    ecalIsoMap = cms.InputTag("modifiedEcalRecHitIsolationScone2nd","EcalRecHitIso"),
    lheEvent = cms.InputTag("externalLHEProducer"),
    maxHT = cms.double(70.0),
    ptThres = cms.double(50.0),
...
process.p = cms.Path(process.ModifiedHEEPIDVarValueMaps+process.ModifiedEcalRecHitIsolationScone+process.egammaPostRecoSeq+process.modifiedHEEPIDVarValueMaps2nd+process.modifiedEcalRecHitIsolationScone2nd+process.mergedEleBkgFilter)
