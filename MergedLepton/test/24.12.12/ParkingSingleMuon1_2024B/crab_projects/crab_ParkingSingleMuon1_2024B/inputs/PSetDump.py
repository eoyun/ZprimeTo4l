...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2024E/ParkingSingleMuon0/MINIAOD/PromptReco-v2/000/381/384/00000/01ddf3b8-c69b-4339-b8bd-8436c76a4c45.root'),
        ...
        modifications = cms.VPSet(
            cms.PSet(
                electron_config = cms.PSet(
                    ...
                    ElectronMVAEstimatorRun2Winter22HZZV1Values = cms.InputTag("electronMVAValueMapProducer","ElectronMVAEstimatorRun2Winter22HZZV1Values"),
            ...
            cms.PSet(
                electron_config = cms.PSet(
                    ...
                    ElectronMVAEstimatorRun2Winter22HZZV1Categories = cms.InputTag("electronMVAValueMapProducer","ElectronMVAEstimatorRun2Winter22HZZV1Categories"),
                    electronSrc = cms.InputTag("slimmedElectrons","","@skipCurrentProcess"),
