...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:MiniAODv4_1.root'),
...
process.mergedLeptonIDImage = cms.EDAnalyzer("MergedLeptonIDImage",
...
process.p = cms.Path(process.evtCounter+process.ModifiedHEEPIDVarValueMaps+process.ModifiedEcalRecHitIsolationScone+process.mergedLeptonIDProducer20UL18+process.egammaPostRecoSeq+process.modifiedHEEPIDVarValueMaps2nd+process.mergedLeptonIDImage)
