...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('hists_Image_sig_250_1.root')
)
...
process.load("ZprimeTo4l.MergedLepton.MergedLeptonIDImage_cfi")
...
process.mergedLeptonIDImage.isMC = cms.bool(False)
