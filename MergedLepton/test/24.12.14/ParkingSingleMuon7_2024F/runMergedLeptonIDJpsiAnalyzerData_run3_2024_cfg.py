...
process.source = cms.Source("PoolSource",
    ...
    #'/store/data/Run2022C/ParkingSingleMuon0/MINIAOD/PromptReco-v1/000/356/488/00000/05236315-30ed-4c16-9288-2a5b7c8786e0.root'
    '/store/data/Run2024E/ParkingSingleMuon0/MINIAOD/PromptReco-v2/000/381/384/00000/01ddf3b8-c69b-4339-b8bd-8436c76a4c45.root'
...
process.GlobalTag.globaltag = cms.string("140X_dataRun3_Prompt_v2")
...
#process.hltFilter.HLTPaths = [cms.vstring("HLT_Mu10_Barrel_L1HP11_IP6*"),cms.vstring("HLT_Mu9_Barrel_L1HP10_IP6*")] # HLT_Mu9_IP6_part* # HLT_IsoMu24_v*
process.hltFilter.HLTPaths = ["HLT_Mu10_Barrel_L1HP11_IP6*","HLT_Mu9_Barrel_L1HP10_IP6*"] # HLT_Mu9_IP6_part* # HLT_IsoMu24_v*
