...
process = cms.Process("MuonJpsiAnalyzer")

process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:MiniAODv4_1_2000_1.root'),
...
process.MuonJpsi = cms.EDAnalyzer("MuonJpsi",
...
process.p = cms.Path(process.evtCounter+process.ModifiedHEEPIDVarValueMaps+process.ModifiedEcalRecHitIsolationScone+process.mergedLeptonIDProducer20UL18+process.egammaPostRecoSeq+process.modifiedHEEPIDVarValueMaps2nd+process.MuonJpsi)
